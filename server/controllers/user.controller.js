...
const register = asyncHandler(async (req, res) => {
    ...
    const localPath = req.files?.avatar && req.files.avatar.length > 0 ? req.files.avatar[0].path : null;
    ...
    const user = await User.create({ username, email, password, avatar: avatar.url });
